...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KodingApi.JCustomPartialsApi = factory(root.KodingApi.ApiClient, root.KodingApi.DefaultResponse, root.KodingApi.DefaultSelector, root.KodingApi.UnauthorizedRequest);
  }
}(this, function(ApiClient, DefaultResponse, DefaultSelector, UnauthorizedRequest) {
  'use strict';

  /**
   * JCustomPartials service.
   * @module koding-api/JCustomPartialsApi
   * @version 0.0.3
   */

  /**
   * Constructs a new JCustomPartialsApi. 
   * @alias module:koding-api/JCustomPartialsApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    this.remove = function(id, body) {
      ...
      return this.apiClient.callApi(
        '/JCustomPartials.remove/{id}', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
    ...
    this.update = function(id, body) {
      ...
      return this.apiClient.callApi(
        '/JCustomPartials.update/{id}', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
