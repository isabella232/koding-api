...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KodingApi.OAuthApi = factory(root.KodingApi.ApiClient, root.KodingApi.DefaultResponse, root.KodingApi.DefaultSelector, root.KodingApi.UnauthorizedRequest);
  }
  ...
  /**
   * OAuth service.
   * @module koding-api/OAuthApi
   * @version 0.0.3
   */

  /**
   * Constructs a new OAuthApi. 
   * @alias module:koding-api/OAuthApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     */
    this.getUrl = function(body) {
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body == undefined || body == null) {
        throw new Error("Missing the required parameter 'body' when calling getUrl");
      }
