...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KodingApi.JUrlAliasApi = factory(root.KodingApi.ApiClient, root.KodingApi.DefaultResponse, root.KodingApi.DefaultSelector, root.KodingApi.UnauthorizedRequest);
  }
  ...
  /**
   * JUrlAlias service.
   * @module koding-api/JUrlAliasApi
   * @version 0.0.3
   */

  /**
   * Constructs a new JUrlAliasApi. 
   * @alias module:koding-api/JUrlAliasApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    this.resolve = function(body) {
      ...
      // verify the required parameter 'body' is set
      if (body == undefined || body == null) {
        throw new Error("Missing the required parameter 'body' when calling resolve");
      }
