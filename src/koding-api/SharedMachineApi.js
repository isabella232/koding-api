...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KodingApi.SharedMachineApi = factory(root.KodingApi.ApiClient, root.KodingApi.DefaultResponse, root.KodingApi.DefaultSelector, root.KodingApi.UnauthorizedRequest);
  }
}(this, function(ApiClient, DefaultResponse, DefaultSelector, UnauthorizedRequest) {
  'use strict';

  /**
   * SharedMachine service.
   * @module koding-api/SharedMachineApi
   * @version 0.0.3
   */

  /**
   * Constructs a new SharedMachineApi. 
   * @alias module:koding-api/SharedMachineApi
   * @class
