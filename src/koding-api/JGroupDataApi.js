...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KodingApi.JGroupDataApi = factory(root.KodingApi.ApiClient, root.KodingApi.DefaultResponse, root.KodingApi.DefaultSelector, root.KodingApi.UnauthorizedRequest);
  }
  ...
  /**
   * JGroupData service.
   * @module koding-api/JGroupDataApi
   * @version 0.0.3
   */

  /**
   * Constructs a new JGroupDataApi. 
   * @alias module:koding-api/JGroupDataApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     */
    this.fetchByKey = function(body) {
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body == undefined || body == null) {
        throw new Error("Missing the required parameter 'body' when calling fetchByKey");
      }
