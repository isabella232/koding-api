...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KodingApi.JCombinedAppStorageApi = factory(root.KodingApi.ApiClient, root.KodingApi.DefaultResponse, root.KodingApi.DefaultSelector, root.KodingApi.UnauthorizedRequest);
  }
}(this, function(ApiClient, DefaultResponse, DefaultSelector, UnauthorizedRequest) {
  'use strict';

  /**
   * JCombinedAppStorage service.
   * @module koding-api/JCombinedAppStorageApi
   * @version 0.0.3
   */

  /**
   * Constructs a new JCombinedAppStorageApi. 
   * @alias module:koding-api/JCombinedAppStorageApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     */
    this.upsert = function(id, body) {
      var postBody = body;

      // verify the required parameter 'id' is set
      if (id == undefined || id == null) {
        throw new Error("Missing the required parameter 'id' when calling upsert");
      }

      // verify the required parameter 'body' is set
      if (body == undefined || body == null) {
        throw new Error("Missing the required parameter 'body' when calling upsert");
      }
      ...
      return this.apiClient.callApi(
        '/JCombinedAppStorage.upsert/{id}', 'POST',
