...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KodingApi.JDomainAliasApi = factory(root.KodingApi.ApiClient, root.KodingApi.DefaultResponse, root.KodingApi.DefaultSelector, root.KodingApi.UnauthorizedRequest);
  }
}(this, function(ApiClient, DefaultResponse, DefaultSelector, UnauthorizedRequest) {
  'use strict';

  /**
   * JDomainAlias service.
   * @module koding-api/JDomainAliasApi
   * @version 0.0.3
   */

  /**
   * Constructs a new JDomainAliasApi. 
   * @alias module:koding-api/JDomainAliasApi
   * @class
