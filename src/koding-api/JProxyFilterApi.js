...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KodingApi.JProxyFilterApi = factory(root.KodingApi.ApiClient, root.KodingApi.DefaultResponse, root.KodingApi.DefaultSelector, root.KodingApi.UnauthorizedRequest);
  }
}(this, function(ApiClient, DefaultResponse, DefaultSelector, UnauthorizedRequest) {
  'use strict';

  /**
   * JProxyFilter service.
   * @module koding-api/JProxyFilterApi
   * @version 0.0.3
   */

  /**
   * Constructs a new JProxyFilterApi. 
   * @alias module:koding-api/JProxyFilterApi
   * @class
