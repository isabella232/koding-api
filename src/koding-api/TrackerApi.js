...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KodingApi.TrackerApi = factory(root.KodingApi.ApiClient, root.KodingApi.DefaultResponse, root.KodingApi.DefaultSelector, root.KodingApi.UnauthorizedRequest);
  }
  ...
  /**
   * Tracker service.
   * @module koding-api/TrackerApi
   * @version 0.0.3
   */

  /**
   * Constructs a new TrackerApi. 
   * @alias module:koding-api/TrackerApi
   * @class
