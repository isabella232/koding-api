...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KodingApi.JApiTokenApi = factory(root.KodingApi.ApiClient, root.KodingApi.DefaultResponse, root.KodingApi.DefaultSelector, root.KodingApi.UnauthorizedRequest);
  }
  ...
  /**
   * JApiToken service.
   * @module koding-api/JApiTokenApi
   * @version 0.0.3
   */

  /**
   * Constructs a new JApiTokenApi. 
   * @alias module:koding-api/JApiTokenApi
   * @class
