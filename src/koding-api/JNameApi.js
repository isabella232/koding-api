...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KodingApi.JNameApi = factory(root.KodingApi.ApiClient, root.KodingApi.DefaultResponse, root.KodingApi.DefaultSelector, root.KodingApi.UnauthorizedRequest);
  }
  ...
  /**
   * JName service.
   * @module koding-api/JNameApi
   * @version 0.0.3
   */

  /**
   * Constructs a new JNameApi. 
   * @alias module:koding-api/JNameApi
   * @class
