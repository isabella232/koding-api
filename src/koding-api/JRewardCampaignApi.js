...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KodingApi.JRewardCampaignApi = factory(root.KodingApi.ApiClient, root.KodingApi.DefaultResponse, root.KodingApi.DefaultSelector, root.KodingApi.UnauthorizedRequest);
  }
}(this, function(ApiClient, DefaultResponse, DefaultSelector, UnauthorizedRequest) {
  'use strict';

  /**
   * JRewardCampaign service.
   * @module koding-api/JRewardCampaignApi
   * @version 0.0.3
   */

  /**
   * Constructs a new JRewardCampaignApi. 
   * @alias module:koding-api/JRewardCampaignApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    this.isValid = function(body) {
      ...
      // verify the required parameter 'body' is set
      if (body == undefined || body == null) {
        throw new Error("Missing the required parameter 'body' when calling isValid");
      }
    ...
    this.remove = function(id, body) {
      ...
      return this.apiClient.callApi(
        '/JRewardCampaign.remove/{id}', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
    ...
    this.update = function(id, body) {
      ...
      return this.apiClient.callApi(
        '/JRewardCampaign.update/{id}', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
