...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KodingApi.ComputeProviderCreateMeta();
  });
  ...
  describe('ComputeProviderCreateMeta', function() {
    it('should create an instance of ComputeProviderCreateMeta', function() {
      // uncomment below and update the code to test ComputeProviderCreateMeta
      //var instane = new KodingApi.ComputeProviderCreateMeta();
      //expect(instance).to.be.a(KodingApi.ComputeProviderCreateMeta);
    });
