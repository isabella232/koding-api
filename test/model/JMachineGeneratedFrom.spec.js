...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KodingApi.JMachineGeneratedFrom();
  });
  ...
  describe('JMachineGeneratedFrom', function() {
    it('should create an instance of JMachineGeneratedFrom', function() {
      // uncomment below and update the code to test JMachineGeneratedFrom
      //var instane = new KodingApi.JMachineGeneratedFrom();
      //expect(instance).to.be.a(KodingApi.JMachineGeneratedFrom);
    });
