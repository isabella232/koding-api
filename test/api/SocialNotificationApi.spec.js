...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KodingApi.SocialNotificationApi();
  });
  ...
  describe('SocialNotificationApi', function() {
    ...
    describe('glance', function() {
      it('should call glance successfully', function(done) {
        //uncomment below and update the code to test glance
        //instance.glance(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
