...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KodingApi.DataDogApi();
  });
  ...
  describe('DataDogApi', function() {
    ...
    describe('sendMetrics', function() {
      it('should call sendMetrics successfully', function(done) {
        //uncomment below and update the code to test sendMetrics
        //instance.sendMetrics(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
