...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KodingApi.JSessionApi();
  });
  ...
  describe('JSessionApi', function() {
    describe('activeSession', function() {
      it('should call activeSession successfully', function(done) {
        //uncomment below and update the code to test activeSession
        //instance.activeSession(function(error) {
