# KodingApi.JDomainAliasApi

All URIs are relative to *https://koding.com/remote.api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**one**](JDomainAliasApi.md#one) | **POST** /JDomainAlias.one | 
[**some**](JDomainAliasApi.md#some) | **POST** /JDomainAlias.some | 
...
var apiInstance = new KodingApi.JDomainAliasApi();
