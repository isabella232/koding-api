# KodingApi.JProxyRestrictionApi

All URIs are relative to *https://koding.com/remote.api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**clear**](JProxyRestrictionApi.md#clear) | **POST** /JProxyRestriction.clear | 
[**create**](JProxyRestrictionApi.md#create) | **POST** /JProxyRestriction.create | 
[**remove**](JProxyRestrictionApi.md#remove) | **POST** /JProxyRestriction.remove | 
[**some**](JProxyRestrictionApi.md#some) | **POST** /JProxyRestriction.some | 


<a name="clear"></a>
# **clear**
> DefaultResponse clear(body)
...
var apiInstance = new KodingApi.JProxyRestrictionApi();

var body = new KodingApi.DefaultSelector(); // DefaultSelector | body of the request

apiInstance.clear(body).then(function(data) {
